...
def SCSolve(el, trans, ip, Omega, b):
	...
	# return sol.y[1,-1] 
	return ForwardEuler(rhs, [x0[0], ip[0]], [x0[1], inflow(x0, Omega)])[1]
...
u.data, info = pyamg.krylov.gmres(A.tocsc(), I, M=spla.LinearOperator(A.shape, SCEval), 
